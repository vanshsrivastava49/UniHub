...
import { MessageSquare, Bell, Search, User, Home, Compass, Settings, Calendar, Users, Heart,FileText } from 'lucide-react';
...
const Header = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    if (searchQuery.startsWith('RA') && searchQuery.length === 14) {
    ...
    <header className="bg-black/20 backdrop-blur-md fixed w-full top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          className="bg-white/10 text-white placeholder-gray-300 px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-[#FFD700] w-55"/>
